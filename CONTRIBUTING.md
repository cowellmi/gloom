...
Thank you for your interest in improving Gloom.
...
The `release` branch of this repo will always have the latest released version of Gloom. All of the active development work for the next release will take place in the `dev` branch. Gloom will use semantic versioning and will create a tag/release for each release.
